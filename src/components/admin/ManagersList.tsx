          ...
          <Card key={manager._id} className="shadow-sm">
            <CardHeader className="flex flex-row items-start justify-between gap-2">
              <div className="min-w-0 flex-1">
                <CardTitle className="text-base sm:text-lg font-bold break-words">{manager.name}</CardTitle>
            ...
            <CardContent className="space-y-2 text-sm sm:text-base">
              <p className="break-words"><strong className="text-muted-foreground">Email:</strong> {manager.email}</p>
              <p className="truncate"><strong className="text-muted-foreground">Team Size:</strong> {manager.teamSize || '0'}</p>
              <p className="break-words"><strong className="text-muted-foreground">Location:</strong> {manager.location || manager.address || 'Not specified'}</p>
      ...
      <Table className="min-w-[800px]">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="hidden md:table-cell min-w-[180px]">Location</TableHead>
        ...
        <TableBody>
          {managers.map((manager: Manager) => (
           <TableRow key={manager._id}>
              <TableCell className="font-medium flex items-center gap-3 max-w-[200px]">
                ...
                <span className="truncate" title={manager.name}>{manager.name}</span>
              </TableCell>
